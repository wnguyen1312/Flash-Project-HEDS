...
#include "Flash.h"
  ...
  call RuntimeParameters_get('y0',      sim_y0)
  call RuntimeParameters_get('ca',      sim_ca)
  call RuntimeParameters_get('vy0',     sim_vy0)
  call RuntimeParameters_get('sigma',   sim_sigma)
